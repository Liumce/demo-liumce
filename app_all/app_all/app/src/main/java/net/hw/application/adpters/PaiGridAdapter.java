...
public class PaiGridAdapter extends BaseAdapter {
    ...
    public PaiGridAdapter(Context context, List<ProductInfoEntity> list) {
...
/*        viewHolder.mIvPhoto.setImageDrawable
        ...
        viewHolder.mTvCount.setText("出价次数："+product.getSalesCount()+"次");
        viewHolder.mTvName.setText(product.getUname());
        viewHolder.mTvPrice.setText("最新拍卖价格：￥"+product.getPrice());
